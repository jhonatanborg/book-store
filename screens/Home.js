...
const Home = ({ navigation }) => {
  ...
  const bookVue = {
    id: 4,
    bookName: "Acelerador Vue.js",
    bookCover: images.vueBook,
    rating: 3.5,
    language: "Eng",
    pageNo: 110,
    author: "Nilson Jacques",
    genre: ["Vue", "Javascript", "Front End"],
    readed: "13k",
    description:
      "Desde seu lançamento em 2014, o Vue.js teve uma ascensão meteórica à popularidade e agora é considerado um dos frameworks front-end primários, e não sem um bom motivo. Sua arquitetura baseada em componentes foi projetada para ser flexível e fácil de adotar, tornando-a tão fácil de integrar em projetos e usar junto com código não-Vue quanto para construir aplicativos complexos do lado do cliente.",
    backgroundColor: "rgba(86, 227, 124,0.9)",
    navTintColor: "#FFF",
  };
  const react = {
    id: 5,
    bookName: "Primeiros passos com React:",
    bookCover: images.react,
    rating: 4.5,
    language: "PT",
    pageNo: 135,
    author: "Nilson Jacques",
    genre: ["React", "Javascript", "Front End"],
    readed: "13k",
    description:
      "Saia trabalhando de imediato com React: a tecnologia de código aberto do Facebook para construir rapidamente aplicações web sofisticadas. Com este guia prático, o desenvolvedor web Stoyan Stefanov ensina você a construir componentes – os blocos de construção básicos da React – e a organizá-los em aplicações de larga escala, viáveis do ponto de vista da manutenção",
    backgroundColor: "rgba(23, 145, 227,0.9)",
    navTintColor: "#FFF",
  };
  ...
  const categoriesData = [
    ...
    },
    {
      ...
      books: [bookTheMetropolis, bookVue, react],
    },
    {
      id: 3,
      categoryName: "Coming Soon",
      books: [bookTheTinyDragon, react],
    },
  ];
  ...
  function renderMyBookSection(myBooks) {
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        >
          <Text style={{ ...FONTS.h3, color: COLORS.white }}>Meus livros</Text>
